...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int item_list[] = new int[15];
        String item_text_list[] = new String[15];
        ...
        item_list[10] = R.drawable.bousi;item_text_list[10] = "帽子 が釣れた！";
    ...
    private int get_item_num(){
        ...
        if(target_radius < screen_height / 9){
            Random rand = new Random();
            randomNumber = rand.nextInt(3);
            return randomNumber;
        }

        if(target_radius < screen_height / 6) {
            Random rand = new Random();
